...
galleryContainer.insertAdjacentHTML("beforeend", renderlist((0, _galleryItemsJs.galleryItems)));
const modalInstance = new (0, _simplelightboxDefault.default)(".gallery__link", {
    captionsData: "alt",
